      ...
      <div className="m-5">
        ...
        <div className="">
          <div className="flex flex-col mt-5 mb-2 gap-1">
            <h3 className="font-bold md:text-[17px] text-sm">Lahan Taman</h3>
            <p className="md:text-base text-sm">Pilih jumlah lahan taman yang akan dibuat</p>
          </div>
        ...
        <div>
          <div className="flex flex-col mt-5 mb-2 gap-1">
            <h3 className="font-bold md:text-[17px] text-sm">Tema Taman</h3>
            <p className="md:text-base text-sm">Pilih tema taman yang akan dibuat</p>
          </div>
          <div>
            <p className="bg-[#FFF2D1] p-5 md:font-bold md:text-base text-xs rounded-lg my-5 md:w-[710px]">
        ...
        <div className="flex md:flex-row flex-col gap-5">
          {gardenTheme.map((data, index) => {
            ...
            return (
              ...
              >
                <img src={img} alt="" className="w-full md:h-[250px] rounded-lg " />
